...
export default function Education() {
  return (
    <section id="education" aria-labelledby="education-heading" className="section-contain relative px-[8%] py-24">
      <SectionHeader number="05" title="Education" id="education-heading" />
